...
%%
%fill in white holes
red_filled = imgaussfilt(imclearborder(imfill(bw_red, 'holes')));
green_filled = imgaussfilt(imclearborder(imfill(bw_green, 'holes')));
blue_filled = imgaussfilt(imclearborder(imfill(bw_blue, 'holes')));
%%
figure(6);
imshow(red_filled);
figure(7);
