...
axis(handles.simulation, [-20 20 -20 20 0 20]);
...
handles.user.link1Patch = armLink01(handles.simulation, [.1 .2 .3]);
...
handles.user.link2Patch = servoLink02(handles.simulation, [.3 .9 .5]);
...
handles.user.link3Patch = armLink02(handles.simulation, [.4 .7 .1]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%Update Envoiment Function---->MUST EDIT%%%%%
function updateArm(hObject, handles)
% DONE: Create the five homogeneous transformation matrices.

link1 = [ 0 0 6.7 0];
link2 = [ 7 0 0 handles.user.jointAngles(1)];
link3 = [ 7 -180 0 handles.user.jointAngles(2)];
link4 = [ 0 0 handles.user.jointAngles(3) 0];
...
link2verticesWRTground =  T(:,:,3)*handles.user.link2Vertices;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Stuff to get ride of/Change to magnet???
